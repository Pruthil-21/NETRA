...
class Settings:
    ...
    # gated by a shared key instead of a user JWT. Required, no fallback --
    # a well-known default here would let anyone who's read this file forge
    # the internal-service header every service-to-service endpoint trusts.
